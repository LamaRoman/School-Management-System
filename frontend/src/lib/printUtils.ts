...
// Design metadata lives in certificateDesigns.ts, which the certificates
// page imports statically (it drives the picker UI, rendered at mount) —
// re-exported here so everything else can still pull it off this module.
import { CERTIFICATE_DESIGNS, type CertificateData } from "./certificateDesigns";
export { CERTIFICATE_DESIGNS, type CertificateData };
